...
class Coches:
    ...
    #El encapsulamiento o visibilad es importnante qporque a trabes de el es posible que python sepa como va a utilizar y manipular los atributos y metodos de clases
    ...
    #Nota: Para utlizar un atributo privado es necesario usarlo en un metodo publico
    ...
    #Nota: Para utilizar un metodo privado es necesario usarlo dentro de un metodo publico
