# El Ciclo while es una estructura iteractiva que se ejecuta x veces siempre 
# y cuando la condicion se cumpla y se seguira ejecutando tantas veces como sea True 
# la condicion
